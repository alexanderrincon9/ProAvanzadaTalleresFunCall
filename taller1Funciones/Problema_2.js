...
//FUNCION TRADICIONAL
/*function obtenerNombres (palabraClave){
     return (palabraClave.split(":"))
}
console.log(obtenerNombres("ARQ2555: Sara Bel-Sun")[1])
console.log(obtenerNombres("ARQ2556: Nodin Chavdri")[1])
console.log(obtenerNombres("ARQ2557: Finn")[1]) */

//FUNCION FLECHA

let obtenerNombres=(palabraClave)=>palabraClave.split(":")

console.log(`el nombre del piloto es: ${obtenerNombres("ARQ2555: Sara Bel-Sun")[1]}`)
